...
const getInitialSubscriptions = () => {
  ...
  return [
    ...
    },
    {
      ...
      cost_price: 35000,
      sell_price: 79000,
      start_date: formatOffsetDate(-29),
      end_date: formatOffsetDate(-1),
      status: 'expired',
      notes: 'Gói gia hạn tự động, cần báo khách gia hạn tiếp'
    },
    {
      id: 'sub-4',
      ...
      end_date: formatOffsetDate(25),
      status: 'active',
      notes: 'Khách mua qua Zalo'
    },
    {
      id: 'sub-5',
      ...
      status: 'active',
      notes: 'Bảo hành trọn đời theo chính sách'
    },
    {
      id: 'sub-6',
      ...
      end_date: formatOffsetDate(15),
      status: 'active',
      notes: 'Khách mua dùng chung nhóm'
    }
  ];
};
    ...
    try {
      const { data, error } = await supabase
        ...
        .insert([{
          ...
          cost_price: Number(sub.cost_price),
          sell_price: Number(sub.sell_price),
